// Run with: node test/pa28-181-takeoff25flap-scenario-test.js  (from server/ directory)
import { calculateTakeoffPerformance } from '../src/lib/takeoff-calc.js';
import * as pa28181Takeoff50Flap25 from '../src/data/pa28-181-takeoff50-25flap-data.js';
...
const SCENARIOS = [
    ...
    {
        name: 'PA28-181 Takeoff50 25°F — 2000 ft / 14°C / 2200 lbs / 5 kt HW  [PLACEHOLDER]',
        data:          pa28181Takeoff50Flap25,
        altitudeFt:    2000,
        altimeterInHg: 29.92,
        oatC:          14,
        weightLbs:     2200,
    ...
    {
        name: 'PA28-181 Takeoff50 25°F — 2000 ft / 14°C / 2200 lbs / 5 kt TW  [PLACEHOLDER]',
        data:          pa28181Takeoff50Flap25,
        altitudeFt:    2000,
        altimeterInHg: 29.92,
        oatC:          14,
    ...
    {
        name: 'PA28-181 Takeoff50 25°F — 4000 ft / 7°C / 2440 lbs / 3 kt HW  [PLACEHOLDER]',
        data:          pa28181Takeoff50Flap25,
        altitudeFt:    4000,
        altimeterInHg: 29.92,
        oatC:          7,
    ...
    {
        name: 'PA28-181 Takeoff50 25°F — 0 ft / -6°C / 1600 lbs / 15 kt HW  [lowest reachable, PLACEHOLDER]',
        data:          pa28181Takeoff50Flap25,
        altitudeFt:    0,
        altimeterInHg: 29.92,
        oatC:          -6,
    ...
    {
        name: 'PA28-181 Takeoff50 25°F — 7000 ft / 11°C / 2440 lbs / 5 kt TW  [highest reachable, PLACEHOLDER]',
        data:          pa28181Takeoff50Flap25,
        altitudeFt:    7000,
        altimeterInHg: 29.92,
        oatC:          11,
