// Run with: node test/pa28-181-takeoffroll25flap-scenario-test.js  (from server/ directory)
import { calculateTakeoffPerformance } from '../src/lib/takeoff-calc.js';
import * as pa28181TakeoffRollFlap25 from '../src/data/pa28-181-takeoffroll-25flap-data.js';

// DRAFT — expected values are placeholders copied from PA-28-161 0° flap scenarios.
// All expected values must be re-baselined once actual PA-28-181 25° flap chart data is digitized.
//
...
const SCENARIOS = [
    ...
    {
        name: 'PA28-181 TakeoffRoll 25°F — 0 ft / 0°C / 2440 lbs / 5 kt HW  [PLACEHOLDER]',
        data:          pa28181TakeoffRollFlap25,
        altitudeFt:    0,
        altimeterInHg: 29.92,
        oatC:          0,
        weightLbs:     2440,
    ...
    {
        name: 'PA28-181 TakeoffRoll 25°F — 0 ft / 0°C / 2440 lbs / 5 kt TW  [PLACEHOLDER]',
        data:          pa28181TakeoffRollFlap25,
        altitudeFt:    0,
        altimeterInHg: 29.92,
        oatC:          0,
    ...
    {
        name: 'PA28-181 TakeoffRoll 25°F — 3000 ft / 9°C / 2440 lbs / 10 kt HW  [PLACEHOLDER]',
        data:          pa28181TakeoffRollFlap25,
        altitudeFt:    3000,
        altimeterInHg: 29.92,
        oatC:          9,
    ...
    {
        name: 'PA28-181 TakeoffRoll 25°F — 3000 ft / 9°C / 2440 lbs / calm  [PLACEHOLDER]',
        data:          pa28181TakeoffRollFlap25,
        altitudeFt:    3000,
        altimeterInHg: 29.92,
        oatC:          9,
    ...
    {
        name: 'PA28-181 TakeoffRoll 25°F — 7000 ft / 1°C / 2440 lbs / calm  [PLACEHOLDER]',
        data:          pa28181TakeoffRollFlap25,
        altitudeFt:    7000,
        altimeterInHg: 29.92,
        oatC:          1,
    ...
    {
        name: 'PA28-181 TakeoffRoll 25°F — 0 ft / -13°C / 1600 lbs / 15 kt HW  [lowest reachable, PLACEHOLDER]',
        data:          pa28181TakeoffRollFlap25,
        altitudeFt:    0,
        altimeterInHg: 29.92,
        oatC:          -13,
    ...
    {
        name: 'PA28-181 TakeoffRoll 25°F — 7000 ft / 17°C / 2440 lbs / calm  [highest reachable HW, PLACEHOLDER]',
        data:          pa28181TakeoffRollFlap25,
        altitudeFt:    7000,
        altimeterInHg: 29.92,
        oatC:          17,
    ...
    {
        name: 'PA28-181 TakeoffRoll 25°F — 7000 ft / 17°C / 2440 lbs / 5 kt TW  [highest reachable TW, PLACEHOLDER]',
        data:          pa28181TakeoffRollFlap25,
        altitudeFt:    7000,
        altimeterInHg: 29.92,
        oatC:          17,
