// Run with: node test/cruise-scenario-test.js  (from server/ directory)
import { getCruiseYRef, getCruiseTAS } from '../src/lib/cruise-calc.js';
import * as pa28181Cruise from '../src/data/pa28-181-cruise-data.js';
...
const SCENARIOS = [
    ...
    { name: 'PA28-181 — PA  1000 / Std  13°C', aircraft: pa28181Cruise, pa:  1000, oat:  13, expected: { yRef: 2, tas75: 112.4, tas65: 104.2, tas55: 92.75 } },
    ...
    { name: 'PA28-181 — PA  4000 / Std   7°C', aircraft: pa28181Cruise, pa:  4000, oat:   7, expected: { yRef: 8, tas75: 116.9, tas65: 108.6, tas55: 96.5 } },
    ...
    { name: 'PA28-181 — PA  8000 / Std  -1°C', aircraft: pa28181Cruise, pa:  8000, oat:  -1, expected: { yRef: 16.3, tas75: 123.7, tas65: 114.9, tas55: 101.8 } },
    ...
    { name: 'PA28-181 — PA 10000 / Std  -5°C / 75% [max curve]', aircraft: pa28181Cruise, pa: 10000, oat:  -5, expected: { yRef: 20, tas75: 123.8, tas65: 117.3, tas55: 104.3 } },
