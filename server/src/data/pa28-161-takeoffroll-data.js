...
export const headwindLookup = [
    { yRef2: 10, points: [{ windKts:  0, dist:  220 }, { windKts:  5, dist:  198 }, { windKts: 10, dist:  178 }, { windKts: 15, dist:  160 }] },
    { yRef2: 20, points: [{ windKts:  0, dist:  490 }, { windKts:  5, dist:  440 }, { windKts: 10, dist:  396 }, { windKts: 15, dist:  357 }] },
    { yRef2: 30, points: [{ windKts:  0, dist:  890 }, { windKts:  5, dist:  800 }, { windKts: 10, dist:  721 }, { windKts: 15, dist:  648 }] },
    { yRef2: 40, points: [{ windKts:  0, dist: 1575 }, { windKts:  5, dist: 1418 }, { windKts: 10, dist: 1276 }, { windKts: 15, dist: 1150 }] },
    { yRef2: 50, points: [{ windKts:  0, dist: 2250 }, { windKts:  5, dist: 2025 }, { windKts: 10, dist: 1823 }, { windKts: 15, dist: 1640 }] },
    { yRef2: 60, points: [{ windKts:  0, dist: 2800 }, { windKts:  5, dist: 2520 }, { windKts: 10, dist: 2268 }, { windKts: 15, dist: 2041 }] },
];

// tailwindLookup — right pane, tailwind section:
// yRef2 × windKts (0–15) → ground roll distance (ft)
export const tailwindLookup = [
    { yRef2: 10, points: [{ windKts:  0, dist:  220 }, { windKts:  5, dist:  246 }, { windKts: 10, dist:  276 }, { windKts: 15, dist:  309 }] },
    { yRef2: 20, points: [{ windKts:  0, dist:  490 }, { windKts:  5, dist:  549 }, { windKts: 10, dist:  615 }, { windKts: 15, dist:  688 }] },
    { yRef2: 30, points: [{ windKts:  0, dist:  890 }, { windKts:  5, dist:  997 }, { windKts: 10, dist: 1117 }, { windKts: 15, dist: 1251 }] },
    { yRef2: 40, points: [{ windKts:  0, dist: 1575 }, { windKts:  5, dist: 1764 }, { windKts: 10, dist: 1976 }, { windKts: 15, dist: 2213 }] },
    { yRef2: 50, points: [{ windKts:  0, dist: 2250 }, { windKts:  5, dist: 2520 }, { windKts: 10, dist: 2822 }, { windKts: 15, dist: 3161 }] },
    { yRef2: 60, points: [{ windKts:  0, dist: 2800 }, { windKts:  5, dist: 3136 }, { windKts: 10, dist: 3512 }, { windKts: 15, dist: 3933 }] },
];
