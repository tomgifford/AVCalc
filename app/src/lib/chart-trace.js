...
// Calc modules live in server/src/lib/ in this branch's workspace layout.
import { getClimbYRef, getDist, getTime, getFuel } from '../../server/src/lib/climb-calc.js';
import { getCruiseYRef, getCruiseTAS } from '../../server/src/lib/cruise-calc.js';
import { getEngineYRef, getEngineRPM } from '../../server/src/lib/engine-calc.js';
import { getIASfromCAS } from '../../server/src/lib/airspeedcal-calc.js';
